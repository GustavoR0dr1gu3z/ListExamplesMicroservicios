...
public class CrudController {	
	...
	//--> CRUD
		//--> CREAR USUARIO
			...
			public Map<String, Object> crearUsuario(@RequestBody Usuario usrBody){				
		...
		//--> READ USUARIO (LISTADO)
			...
			//--> Listado por Email
				...
				public Map<String, Object> listUserByEmail(@RequestParam("email") String email){
					return usuarioService.searchUserByEmail(email);
				}
		//-->UPDATE USUARIO
			//-->Update By Id
				@PutMapping(value="/update/{id}", produces=MediaType.APPLICATION_JSON_VALUE)
				public Map<String, Object> updateUsrById(@PathVariable("id") Long id, @RequestBody Usuario usrBody){
